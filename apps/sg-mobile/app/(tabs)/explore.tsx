...
export default function TabTwoScreen() {
    return (
        ...
        >
            ...
            <Text>
                Welcome to the Explore screen! This is a great place to learn about the features of
                this template and how to use it as a starting point for your own Expo Router app.
            </Text>
